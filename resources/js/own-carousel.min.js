...
document.addEventListener('DOMContentLoaded', () => {
    const containers = document.querySelectorAll('.own-carousel__container');
    containers.forEach(container => {
        const itemPerRow = parseInt(container.dataset.row);
        const itemWidth = parseInt(container.dataset.width);
        const loopAttributeValue = container.dataset.loop;
        const navAttributeValue = container.dataset.nav;
        const loop = loopAttributeValue === '1';
        const nav = navAttributeValue === '1';
        container.ownCarousel({
